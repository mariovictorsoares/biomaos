    ...
    >
      <div class="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div class="flex min-h-full items-center justify-center p-2 sm:p-4">
          ...
          <!-- Header -->
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700 gap-3 flex-shrink-0">
            <h2 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Cadastro de pedido</h2>
            <div class="flex items-center gap-2 sm:gap-3">
              <button
                @click="$emit('close')"
                class="flex-1 sm:flex-none btn btn-secondary text-sm"
              >
                Voltar
              </button>
              <button
                @click="handleSave"
                class="flex-1 sm:flex-none btn btn-primary text-sm"
...
// Inicializar lista local de tabelas
onMounted(() => {
