      ...
      <div class="relative w-full max-w-2xl bg-white rounded-xl shadow-xl transform transition-all">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">{{ cliente?.nomeFantasia || cliente?.razaoSocial }}</p>
          </div>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
          <button class="text-sm text-red-600 hover:text-red-700 font-medium flex items-center gap-2">
...
watch(() => props.cliente, (newCliente) => {
  ...
  if (newCliente) {
    ...
    form.value.nomeFantasia = newCliente.nomeFantasia || ''
    form.value.cidade = newCliente.cidade || ''
